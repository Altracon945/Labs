...
![](media/Screenshot_19.png)
Workflow:
![](media/Screenshot_20.png)
Додавання до сайту стрічки про хоббі:
![](media/Screenshot_21.png)
Завантаження цієї стрічки:
![](media/Screenshot_22.png)
Мій сайт(оновлений):
![](media/Screenshot_23.png)
Створення приватного репозиторію:
![](media/Screenshot_24.png)
Додавання іншого користувача до мого приватного репозиторію:
![](media/Screenshot_25.png)